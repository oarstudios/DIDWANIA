...
function EditProduct() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      if (response.ok) {
        ...
        setImage1Preview(`https://147.93.103.125/uploads/${json.product?.productImages[0]}`);
        setImage2Preview(`https://147.93.103.125/uploads/${json.product?.productImages[1]}`);
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch(`https://147.93.103.125/products/updateproduct/${id}`, {
      method: 'PUT',
      body: formData,
    });
  ...
  const handleDelete = async (e) => {
    ...
    const response = await fetch(`https://147.93.103.125/products/deleteproduct/${id}`, {
      method: 'DELETE'
    });
