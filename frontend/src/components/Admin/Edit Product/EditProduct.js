...
function EditProduct() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      if (response.ok) {
        ...
        setImage1Preview(`https://didwaniacreations.in/uploads/${json.product?.productImages[0]}`);
        setImage2Preview(`https://didwaniacreations.in/uploads/${json.product?.productImages[1]}`);
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch(`https://didwaniacreations.in/products/updateproduct/${id}`, {
      method: 'PUT',
      body: formData,
    });
  ...
  const handleDelete = async (e) => {
    ...
    const response = await fetch(`https://didwaniacreations.in/products/deleteproduct/${id}`, {
      method: 'DELETE'
    });
