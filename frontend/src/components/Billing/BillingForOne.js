...
//   }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://backend.didwaniacreations.in/bills/billforone/${user.user?._id}/${id}`, {
        method: "POST",
                ...
                <div key={cartItems._id} className="cItem1 cItem11">
                  <div className="cItem cItemm">
                    <div className="cItemImg cItemImgg">
                      <img src={`https://backend.didwaniacreations.in/uploads/${cartItems.product?.productImages[0]}`} alt={cartItems.product?.title} />
                    </div>
