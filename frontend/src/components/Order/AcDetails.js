...
function AcDetails() {
  ...
  useEffect(()=>{
    const fetchData = async()=>{
      const response = await fetch(`https://backend.didwaniacreations.in/users/getuserbyid/${id}`)
...
const newUserData = {
  ...
  const handleSubmit = async(e) =>{
    ...
    try{
      ...
      const response = await fetch(`https://backend.didwaniacreations.in/users/updateuser/${id}`, {
        method: 'PUT',
        headers: {
